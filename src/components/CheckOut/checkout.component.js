...
import { setAddItemToCart, setClearItemFromCart, setRemoveItemFromCart } from "../../store/cart/cart.action";
    ...
    return (
        ...
        <div className="checkOutPageContainer">
                ...
                return (
                    <div className="checkOutItemContainer">
                        ...
                        <div className="itemQuntityContainer">
                            <AddIcon style={{ cursor: 'pointer' }} onClick={increaseItemhandler.bind(null, item)} />

                            <h4>{item.quntity}</h4>

                            <RemoveIcon style={{ cursor: 'pointer' }} onClick={decreaseItemhandler.bind(null, item)} />

                        </div>


                        <CloseIcon style={{ cursor: 'pointer' }} onClick={removeItemhandler.bind(null, item)} />
            ...
            <div className="subTotalContainer">
                ...
                <h5 style={{ color: 'rgba(56, 52, 52, 0.68)', textTransform: 'uppercase', letterSpacing: '3px' }}>SubTotal -</h5>
